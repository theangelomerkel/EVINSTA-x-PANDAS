...
class RaguideWidget extends StatefulWidget {
  ...
  @override
  State<RaguideWidget> createState() => _RaguideWidgetState();
}

class _RaguideWidgetState extends State<RaguideWidget> {
  late RaguideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RaguideModel());
