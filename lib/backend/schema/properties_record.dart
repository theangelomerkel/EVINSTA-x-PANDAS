...
class PropertiesRecord extends FirestoreRecord {
  ...
  // "guestRef" field.
  List<DocumentReference>? _guestRef;
  List<DocumentReference> get guestRef => _guestRef ?? const [];
  bool hasGuestRef() => _guestRef != null;

  // "amountPersons" field.
  int? _amountPersons;
  int get amountPersons => _amountPersons ?? 0;
  bool hasAmountPersons() => _amountPersons != null;
  ...
  // "paypalURL" field.
  String? _paypalURL;
  String get paypalURL => _paypalURL ?? '';
  bool hasPaypalURL() => _paypalURL != null;
  ...
  // "ratingAverage" field.
  List<double>? _ratingAverage;
  List<double> get ratingAverage => _ratingAverage ?? const [];
  bool hasRatingAverage() => _ratingAverage != null;

  // "publicEvent" field.
  bool? _publicEvent;
  bool get publicEvent => _publicEvent ?? false;
  bool hasPublicEvent() => _publicEvent != null;

  // "refusedList" field.
  List<DocumentReference>? _refusedList;
  List<DocumentReference> get refusedList => _refusedList ?? const [];
  bool hasRefusedList() => _refusedList != null;
  ...
  void _initializeFields() {
    ...
    _guestRef = getDataList(snapshotData['guestRef']);
    _amountPersons = castToType<int>(snapshotData['amountPersons']);
    _date = snapshotData['date'] as DateTime?;
    _paypalURL = snapshotData['paypalURL'] as String?;
    _spotifyURL = snapshotData['spotifyURL'] as String?;
    _backgroundIMG = snapshotData['backgroundIMG'] as String?;
    _ratingAverage = getDataList(snapshotData['ratingAverage']);
    _publicEvent = snapshotData['publicEvent'] as bool?;
    _refusedList = getDataList(snapshotData['refusedList']);
...
class PropertiesRecordDocumentEquality implements Equality<PropertiesRecord> {
  ...
  bool equals(PropertiesRecord? e1, PropertiesRecord? e2) {
    ...
    return e1?.propertyName == e2?.propertyName &&
        ...
        e1?.isLive == e2?.isLive &&
        listEquality.equals(e1?.guestRef, e2?.guestRef) &&
        e1?.amountPersons == e2?.amountPersons &&
        e1?.date == e2?.date &&
        e1?.paypalURL == e2?.paypalURL &&
        e1?.spotifyURL == e2?.spotifyURL &&
        e1?.backgroundIMG == e2?.backgroundIMG &&
        listEquality.equals(e1?.ratingAverage, e2?.ratingAverage) &&
        e1?.publicEvent == e2?.publicEvent &&
        listEquality.equals(e1?.refusedList, e2?.refusedList) &&
        e1?.phone == e2?.phone;
  }
