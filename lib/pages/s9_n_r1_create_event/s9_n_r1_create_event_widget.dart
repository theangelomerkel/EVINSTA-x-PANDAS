...
class S9NR1CreateEventWidget extends StatefulWidget {
  ...
  @override
  State<S9NR1CreateEventWidget> createState() => _S9NR1CreateEventWidgetState();
}
...
class _S9NR1CreateEventWidgetState extends State<S9NR1CreateEventWidget> {
  ...
  void initState() {
    ...
    _model.neighbTextController ??= TextEditingController();
    ...
    _model.paypalTextController ??= TextEditingController();
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'bzw2opt8' /* BSP: Extra Description */,
                                          ),
                                          hintStyle: FlutterFlowTheme.of(
                                                  context)
                                              .headlineSmall
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'k5rlz77b' /* Property neighborhood */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: TextFormField(
                                        controller: _model.neighbTextController,
                                        focusNode: _model.neighbFocusNode,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'jqhwbbpl' /* 123 Disney way here… */,
                                          ),
                                          hintStyle: FlutterFlowTheme.of(
                                                  context)
                                              .bodyMedium
                                  ...
                                  onPressed: () async {
                                    ...
                                    await propertiesRecordReference.set({
                                      ...createPropertiesRecordData(
                                        ...
                                        propertyDescription:
                                            valueOrDefault<String>(
                                          _model.neighbTextController.text,
                                          '0',
                                        ),
                                        ...
                                        paypalURL:
                                            _model.paypalTextController.text,
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'msx7uomf' /* add Artist or soundcloud link */,
                                                ),
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .headlineSmall
